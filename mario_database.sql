...
CREATE TABLE `userFriend` (
  ...
  `friendRelation` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`friendId`,`userId`),
  KEY `userId` (`userId`),
  CONSTRAINT `userfriend_ibfk_1` FOREIGN KEY (`userId`) REFERENCES `users` (`userId`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `users` (
  ...
  `curAllRank` int(11) DEFAULT NULL,
  `friendRank` int(11) DEFAULT NULL,
  PRIMARY KEY (`userId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (0,'l',';',0,0,0);
...
CREATE TABLE `userscore` (
  ...
  `score` int(11) NOT NULL,
  PRIMARY KEY (`userId`),
  CONSTRAINT `userscore_ibfk_1` FOREIGN KEY (`userId`) REFERENCES `users` (`userId`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-05-26 12:23:10
